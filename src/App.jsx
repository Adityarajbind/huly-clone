  ...
  return (
    <>
      ...
      <div
        ...
        className="hero-section w-full h-full relative z-0"
      ...
      >
        ...
        {/* main text */}
        <div className="main-text absolute text-white top-[30%] translate-y-[-50%] w-[90%] sm:w-[80%] md:w-[60%] lg:w-[50%] xl:w-[40%] mx-4 sm:mx-6 md:mx-10">
          <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-[4rem] font-bold leading-[1] mb-4  ">
            Everything App <p>for your teams</p>
          </h1>
          <p className="text-base sm:text-lg md:text-xl mb-6 max-sm:w-3/4">
      ...
      <div className="w-full bg-[#090a0c] text-white py-[2rem] px-4 sm:px-6 md:px-10 relative shadow-[0_0_50px_50px_#090a0c]">
      ...
      <div className="bg-[#f6f6f6] w-full flex justify-center flex-col items-center stay-productive relative z-10 py-36 lg:pt-25 md:py-22 sm:py-14">
        ...
        <p className="text-[#1d1e1ff1] text-[1.1rem] w-[71%] ">
          <h1>
            Huly is a process, project, time, and knowledge management platform
            that provides
          </h1>
          <h1>
            amazing collaboration opportunities for developers and product teams
            alike.
          </h1>
        </p>
        <div className="w-[75%] flex justify-center items-center flex-col mt-9 gap-4">
          <div className="w-full flex justify-center items-center gap-4">
            <div className="w-[34%] h-[19rem] relative">
              <img
                ref={imgRef}
                src={imgSrc}
            ...
            <div className="w-[60.5%] h-[18.9rem] relative rounded-xl">
              <TaskLayout />
              <div className="m-5 text-[#99999a] text-[1.1rem] absolute bottom-0 z-40">
          ...
          <div className="w-full flex justify-center items-center flex-row-reverse gap-4">
            ...
            <div className="w-[60.5%] h-[18.9rem] relative rounded-xl">
              <TaskGraphLayout />
              <div className="m-5 text-[#99999a] text-[1.1rem] absolute bottom-0 z-50">
